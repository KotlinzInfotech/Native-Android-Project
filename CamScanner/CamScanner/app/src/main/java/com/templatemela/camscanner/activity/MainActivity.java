...
public class MainActivity extends BaseActivity implements View.OnClickListener, PopupMenu.OnMenuItemClickListener {
    ...
    BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (MyApplication.IdentifyActivity.equals("PrivacyPolicyActivity")) {
                startActivity(new Intent(MainActivity.this, PrivacyPolicyActivity.class));
                MyApplication.IdentifyActivity = "";
            } else if (MyApplication.IdentifyActivity.equals("QRGenerateActivity")) {
                startActivity(new Intent(MainActivity.this, QRGenerateActivity.class));
                MyApplication.IdentifyActivity = "";
            } else if (MyApplication.IdentifyActivity.equals("QRReaderActivity")) {
                startActivity(new Intent(MainActivity.this, QRReaderActivity.class));
                MyApplication.IdentifyActivity = "";
            } else if (MyApplication.IdentifyActivity.equals("MainGalleryActivity")) {
                ImagePicker.with(MainActivity.this)
                        ...
                        .start();
                MyApplication.IdentifyActivity = "";
            } else if (MyApplication.IdentifyActivity.equals("ScannerActivity")) {
                startActivity(new Intent(MainActivity.this, ScannerActivity.class));
                MyApplication.IdentifyActivity = "";
            } else if (MyApplication.IdentifyActivity.equals("GroupDocumentActivity")) {
                Intent intent2 = new Intent(MainActivity.this, GroupDocumentActivity.class);
                intent2.putExtra("current_group", current_group);
                startActivity(intent2);
                MyApplication.IdentifyActivity = "";
            } else if (MyApplication.IdentifyActivity.equals("CropDocumentActivity")) {
    ...
    private final ArrayList<DrawerModel> drawerList = new ArrayList<>();
    ...
    private void init() {
        ...
        iv_group_camera = findViewById(R.id.iv_group_camera);
    }
    ...
    private void openNewFolderDialog(String groupName) {
        ...
        EditText et_folder_name = dialog.findViewById(R.id.et_folder_name);
    ...
    public void onRequestPermissionsResult(int i, String[] strArr, int[] iArr) {
        ...
        if (i != 1) {
            if (i != 2) {
                if (i != 3) {
                        ...
                        if (checkSelfPermission("android.permission.READ_EXTERNAL_STORAGE") == PackageManager.PERMISSION_GRANTED && checkSelfPermission("android.permission.WRITE_EXTERNAL_STORAGE") == PackageManager.PERMISSION_GRANTED && checkSelfPermission("android.permission.CAMERA") == PackageManager.PERMISSION_GRANTED) {
                            if (MyApplication.isShowAd == 0) {
                                if (MyApplication.mInterstitialAd != null) {
                                    ...
                                    MyApplication.IdentifyActivity = "QRGenerateActivity";
                    ...
                    if (MyApplication.isShowAd == 0) {
                        if (MyApplication.mInterstitialAd != null) {
                            MyApplication.activity = activity;
                            MyApplication.IdentifyActivity = "QRReaderActivity";
                            MyApplication.mInterstitialAd.show(activity);
                            MyApplication.isShowAd = 1;
                        } else {
                            startActivity(new Intent(MainActivity.this, QRReaderActivity.class));
                ...
                if (MyApplication.isShowAd == 0) {
                    if (MyApplication.mInterstitialAd != null) {
                        MyApplication.activity = activity;
                        MyApplication.IdentifyActivity = "ScannerActivity";
                        MyApplication.mInterstitialAd.show(activity);
                        MyApplication.isShowAd = 1;
                    } else {
                        startActivity(new Intent(MainActivity.this, ScannerActivity.class));
            ...
            if (MyApplication.isShowAd == 0) {
                if (MyApplication.mInterstitialAd != null) {
                    MyApplication.activity = activity;
                    MyApplication.IdentifyActivity = "MainGalleryActivity";
                    MyApplication.mInterstitialAd.show(activity);
                    MyApplication.isShowAd = 1;
                } else {
                    ImagePicker.with(MainActivity.this)
    ...
    public boolean onMenuItemClick(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            ...
            case R.id.sort_by:
                ...
                builder.setSingleChoiceItems(strArr, selected_sorting_pos, new DialogInterface.OnClickListener() {
                    @Override
                    ...
                    Glide.with(getApplicationContext()).asBitmap().load(next.getUri()).into(new SimpleTarget<Bitmap>() {
                        public void onResourceReady(Bitmap bitmap, Transition<? super Bitmap> transition) {
                            ...
                            if (MyApplication.isShowAd == 0) {
                                if (MyApplication.mInterstitialAd != null) {
                                    MyApplication.activity = activity;
                                    MyApplication.IdentifyActivity = "CropDocumentActivity";
                                    MyApplication.mInterstitialAd.show(activity);
                                    MyApplication.isShowAd = 1;
                                } else {
                                    startActivity(new Intent(MainActivity.this, CropDocumentActivity.class));
        ...
        public void onPostExecute(String str) {
            ...
            if (groupList.size() > 0) {
                ...
                if (current_mode.equals("Grid")) {
                    mainActivity.layoutManager = new GridLayoutManager(mainActivity, 2, RecyclerView.VERTICAL, false);
                } else {
    ...
    public void clickOnListItem(String str) {
        ...
        if (MyApplication.isShowAd == 0) {
            if (MyApplication.mInterstitialAd != null) {
                MyApplication.activity = activity;
                MyApplication.IdentifyActivity = "GroupDocumentActivity";
                MyApplication.mInterstitialAd.show(activity);
                MyApplication.isShowAd = 1;
            } else {
                Intent intent2 = new Intent(MainActivity.this, GroupDocumentActivity.class);
    ...
    public void clickOnListMore(DBModel dbModel, final String name, String date) {
        ...
        rl_save_as_pdf.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (AdmobAds.SHOW_ADS) {
                    AdmobAds.loadNativeAds(MainActivity.this, null, dialog.findViewById(R.id.admob_native_container), dialog.findViewById(R.id.native_ad_view));
                } else {
        ...
        inflate.findViewById(R.id.rl_rename).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        rl_save_to_gallery.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new saveGroupToGallery(name).execute();
                bottomSheetDialog.dismiss();
            }
        });
    ...
    private void openMoveFolderDialog(DBModel selectedDBModel) {
        ...
        LinearLayout ll_new_folder_add = dialog.findViewById(R.id.ll_new_folder_add);
...
//                    Log.e("name ", selectedFolderName);
        ...
        dialog.findViewById(R.id.tv_done).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (textView.getText().toString().equals("Save as PDF")) {
                    new saveGroupAsPDF(name, PdfObject.TEXT_PDFDOCENCODING, "", et_pdf_name.getText().toString()).execute();
                    dialog.dismiss();
                    return;
                }
    ...
    public void shareGroup(final String name) {
        ...
        dialog.findViewById(R.id.rl_share_pdf).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new shareGroupAsPDF(name, PdfObject.TEXT_PDFDOCENCODING, "", "", "all").execute();
                dialog.dismiss();
            }
        });
        ...
        dialog.findViewById(R.id.tv_done).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (et_enter_pswrd.getText().toString().equals("") || et_confirm_pswrd.getText().toString().equals("")) {
                    ...
                    new shareGroupAsPDF(name, "PDF With Password", et_enter_pswrd.getText().toString(), "", "all").execute();
                    dialog.dismiss();
                } else {
                    new saveGroupAsPDF(name, "PDF With Password", et_enter_pswrd.getText().toString(), pdfName).execute();
                    dialog.dismiss();
                }
            }
        });
        ...
        dialog.findViewById(R.id.tv_done).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (editText.getText().toString().equals("")) {
                    ...
                    new shareGroupAsPDF(name, PdfObject.TEXT_PDFDOCENCODING, "", editText.getText().toString(), shareType).execute();
                    dialog.dismiss();
                }
            }
        });
    ...
    public void onDrawerItemSelected(int i) {
        if (i == 0) {
            ...
            if (MyApplication.isShowAd == 0) {
                if (MyApplication.mInterstitialAd != null) {
                    MyApplication.activity = activity;
                    MyApplication.IdentifyActivity = "PrivacyPolicyActivity";
                    MyApplication.mInterstitialAd.show(activity);
                    MyApplication.isShowAd = 1;
                } else {
                    startActivity(new Intent(MainActivity.this, PrivacyPolicyActivity.class));
