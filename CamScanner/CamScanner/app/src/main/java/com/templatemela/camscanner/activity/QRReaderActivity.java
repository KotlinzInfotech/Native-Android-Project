...
public class QRReaderActivity extends BaseActivity implements ZXingScannerView.ResultHandler {
    ...
    private void PutAnalyticsEvent() {
        ...
        bundle.putString(FirebaseAnalytics.Param.CONTENT_TYPE, "QRReaderActivity");
        mFirebaseAnalytics.logEvent(FirebaseAnalytics.Event.SELECT_CONTENT, bundle);
    }

    private void init() {
        viewGroup = findViewById(R.id.fl_camera);
    ...
    public void handleResult(Result result) {
        ...
        if (AdmobAds.SHOW_ADS) {
            AdmobAds.loadNativeAds(QRReaderActivity.this, null, dialog.findViewById(R.id.admob_native_container), dialog.findViewById(R.id.native_ad_view));
        } else {
        ...
        dialog.findViewById(R.id.tv_search).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent;
                if (barcode_result.startsWith("tel")) {
