...
public class DocumentEditorActivity extends BaseActivity implements View.OnClickListener, EditToolsAdapter.OnToolSelected, SeekBar.OnSeekBarChangeListener {
    Activity activity = DocumentEditorActivity.this;
    ...
    BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (MyApplication.IdentifyActivity.equals("SavedEditDocumentActivity")) {
    ...
    private void PutAnalyticsEvent() {
        ...
        bundle.putString(FirebaseAnalytics.Param.CONTENT_TYPE, "DocumentEditorActivity");
...
//        ly_aspectratio = (AspectRatioLayout) findViewById(R.id.ly_aspectratio);
        ...
        iv_apply_filter = findViewById(R.id.iv_apply_filter);
        ...
        iv_close_adjust = findViewById(R.id.iv_close_adjust);
        iv_apply_adjust = findViewById(R.id.iv_apply_adjust);
        ...
        llHighLight = findViewById(R.id.llHighLight);
        ...
        iv_close_highlight = findViewById(R.id.iv_close_highlight);
        iv_apply_highlight = findViewById(R.id.iv_apply_highlight);
        ly_opacity = findViewById(R.id.ly_opacity);
        sb_opacity = findViewById(R.id.sb_opacity);
        iv_close_opacity = findViewById(R.id.iv_close_opacity);
        iv_apply_opacity = findViewById(R.id.iv_apply_opacity);
        ...
        iv_close_signature = findViewById(R.id.iv_close_signature);
        iv_apply_signature = findViewById(R.id.iv_apply_signature);
        ...
        iv_watermark_font = findViewById(R.id.iv_watermark_font);
        iv_watermark_color = findViewById(R.id.iv_watermark_color);
        iv_watermark_opacity = findViewById(R.id.iv_watermark_opacity);
        iv_close_watermark = findViewById(R.id.iv_close_watermark);
        iv_apply_watermark = findViewById(R.id.iv_apply_watermark);
        ...
        iv_txt_font = findViewById(R.id.iv_txt_font);
        iv_txt_color = findViewById(R.id.iv_txt_color);
        iv_txt_alignment = findViewById(R.id.iv_txt_alignment);
        iv_close_txt = findViewById(R.id.iv_close_txt);
        iv_apply_txt = findViewById(R.id.iv_apply_txt);
        ly_overlay = findViewById(R.id.ly_overlay);
        sb_overlay = findViewById(R.id.sb_overlay);
        rv_overlay = findViewById(R.id.rv_overlay);
        iv_close_overlay = findViewById(R.id.iv_close_overlay);
        iv_apply_overlay = findViewById(R.id.iv_apply_overlay);
        ...
        iv_apply_effect = findViewById(R.id.iv_apply_effect);
...
//        ly_aspectratio.setAspectRatio((float) Constant.original.getWidth(), (float) Constant.original.getHeight());
        ...
        switch (id) {
            ...
            case R.id.iv_apply_signature:
                if (!signature_view.isBitmapEmpty()) {
                    ...
                    new saveSignature().execute(signatureBitmap);
                    return;
                }
                return;
    ...
    public void addTextDialog(String str, boolean isText) {
        ...
        if (AdmobAds.SHOW_ADS) {
            AdmobAds.loadNativeAds(DocumentEditorActivity.this, null, dialog.findViewById(R.id.admob_native_container), dialog.findViewById(R.id.native_ad_view));
        } else {
            dialog.findViewById(R.id.admob_native_container).setVisibility(View.GONE);
        }
        final EditText editText = dialog.findViewById(R.id.et_input_txt);
...
//        editText.setTextColor(defaultTxtColor);
    ...
    public void onClickSignature(int i) {
        stickerView.addSticker(new DrawableSticker(new BitmapDrawable(getResources(), getBitmap(new File(signatureList.get(i))))), 1);
        rl_signature.setVisibility(View.GONE);
        sb_opacity.setProgress(255);
    ...
    private void setSignatureList() {
        File[] listFiles = new File(getExternalFilesDir(null).getAbsolutePath() + "/Signature").listFiles();
        if (listFiles != null) {
    ...
    private class saveSignature extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        public Bitmap doInBackground(Bitmap... bitmapArr) {
            if (bitmapArr.length > 0) {
                ...
                if (bitmap != null) {
                    ...
                    File file = new File(getExternalFilesDir(null).getAbsolutePath(), "/Signature");
        ...
        public void onPostExecute(Bitmap bitmap2) {
            ...
            stickerView.addSticker(new DrawableSticker(new BitmapDrawable(getResources(), bitmap2)), 1);
            rl_signature.setVisibility(View.GONE);
            sb_opacity.setProgress(255);
            ...
            if (fromTAG.equals("IDCardPreviewActivity")) {
                ...
                if (MyApplication.isShowAd == 1) {
                    ...
                    if (MyApplication.mInterstitialAd != null) {
                        ...
                        MyApplication.IdentifyActivity = "SavedEditDocumentActivity";
