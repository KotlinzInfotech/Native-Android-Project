...
package com.boy.photo.editor.fashion.men.beard.mustache.hair.style.AppUpdate;
...
public class InAppUpdateManager implements LifecycleObserver {
    ...
    /**
     * Use custom notification for the user confirmation needed by the {@link Constants.UpdateMode#FLEXIBLE} flow.
     ...
     * will start the update process with the selected {@link Constants.UpdateMode}.
     */
