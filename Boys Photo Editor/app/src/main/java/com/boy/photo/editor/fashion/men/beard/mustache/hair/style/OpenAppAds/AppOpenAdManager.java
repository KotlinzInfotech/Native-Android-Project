package com.boy.photo.editor.fashion.men.beard.mustache.hair.style.OpenAppAds;
...
public class AppOpenAdManager {
    ...
    public void showAdIfAvailable(@NonNull final Activity activity) {
        showAdIfAvailable(
                activity,
                new AppController.OnShowAdCompleteListener() {
                    @Override
    ...
    public void showAdIfAvailable(
            ...
            @NonNull AppController.OnShowAdCompleteListener onShowAdCompleteListener) {
