package com.cybertechinfosoft.photoslideshowwithmusic.NativeAds;
...
public class nativeads {
    ...
    public static void populateUnifiedNativeAdViewbig(NativeAd nativeAd, NativeAdView adView) {
