...
public class IFWaldenFilter extends InstaFilter {
    ...
    public IFWaldenFilter(Context context) {
        super(SHADER, 2);
        this.bitmaps[0] = BitmapFactory.decodeResource(context.getResources(), R.drawable.walden_map);
        this.bitmaps[1] = BitmapFactory.decodeResource(context.getResources(), R.drawable.vignette_map);
    }
