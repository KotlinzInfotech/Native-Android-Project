...
public class IFToasterFilter extends InstaFilter {
    ...
    public IFToasterFilter(Context context) {
        super(SHADER, 5);
        this.bitmaps[0] = BitmapFactory.decodeResource(context.getResources(), R.drawable.toaster_metal);
        this.bitmaps[1] = BitmapFactory.decodeResource(context.getResources(), R.drawable.toaster_soft_light);
        this.bitmaps[2] = BitmapFactory.decodeResource(context.getResources(), R.drawable.toaster_curves);
        this.bitmaps[3] = BitmapFactory.decodeResource(context.getResources(), R.drawable.toaster_overlay_map_warm);
        this.bitmaps[4] = BitmapFactory.decodeResource(context.getResources(), R.drawable.toaster_color_shift);
    }
}
