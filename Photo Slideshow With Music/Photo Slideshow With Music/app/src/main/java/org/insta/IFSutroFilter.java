...
public class IFSutroFilter extends InstaFilter {
    ...
    public IFSutroFilter(Context context) {
        super(SHADER, 5);
        this.bitmaps[0] = BitmapFactory.decodeResource(context.getResources(), R.drawable.vignette_map);
        this.bitmaps[1] = BitmapFactory.decodeResource(context.getResources(), R.drawable.sutro_metal);
        this.bitmaps[2] = BitmapFactory.decodeResource(context.getResources(), R.drawable.soft_light);
        this.bitmaps[3] = BitmapFactory.decodeResource(context.getResources(), R.drawable.sutro_edge_burn);
        this.bitmaps[4] = BitmapFactory.decodeResource(context.getResources(), R.drawable.sutro_curves);
    }
}
