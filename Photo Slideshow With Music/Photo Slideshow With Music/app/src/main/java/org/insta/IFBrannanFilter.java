...
public class IFBrannanFilter extends InstaFilter {
    ...
    public IFBrannanFilter(Context context) {
        super(SHADER, 5);
        this.bitmaps[0] = BitmapFactory.decodeResource(context.getResources(), R.drawable.brannan_process);
        this.bitmaps[1] = BitmapFactory.decodeResource(context.getResources(), R.drawable.brannan_blowout);
        this.bitmaps[2] = BitmapFactory.decodeResource(context.getResources(), R.drawable.brannan_contrast);
        this.bitmaps[3] = BitmapFactory.decodeResource(context.getResources(), R.drawable.brannan_luma);
        this.bitmaps[4] = BitmapFactory.decodeResource(context.getResources(), R.drawable.brannan_screen);
    }
}
