...
public class IFHefeFilter extends InstaFilter {
    ...
    public IFHefeFilter(Context context) {
        super(SHADER, 5);
        this.bitmaps[0] = BitmapFactory.decodeResource(context.getResources(), R.drawable.edge_burn);
        this.bitmaps[1] = BitmapFactory.decodeResource(context.getResources(), R.drawable.hefe_map);
        this.bitmaps[2] = BitmapFactory.decodeResource(context.getResources(), R.drawable.hefe_gradient_map);
        this.bitmaps[3] = BitmapFactory.decodeResource(context.getResources(), R.drawable.hefe_soft_light);
        this.bitmaps[4] = BitmapFactory.decodeResource(context.getResources(), R.drawable.hefe_metal);
    }
}
